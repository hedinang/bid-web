...
import logo from "../../assets/bid-icon.png";
        ...
        <Form.Item>
          <div className="general-modal justify-center items-center gap-[20px]">
            {loading ? (
                ...
                <Button
                    className="button bg-[#46ac40] text-[white]" htmlType="submit"
                >
                  Đăng nhập
                </Button>
            }
            <Button className="button bg-[#f4511e] text-[white]" onClick={onCancel}>
              Hủy
            </Button>
          </div>
        </Form.Item>
